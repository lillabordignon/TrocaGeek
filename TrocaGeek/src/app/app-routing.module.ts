...
const routes: Routes = [
  ...
  { path: 'produtos/categoria/actionfigure', component: ActionfigureComponent },
  { path: 'produtos/categoria/cardgame', component: CardgameComponent },
  { path: 'produtos/categoria/acessorios', component: AcessoriosComponent },
